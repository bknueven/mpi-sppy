...
def ph_xhat_spoke(
    ...
    if _hasit(cfg, "ph_xhat_rho_multiplier"):
        ph_xhat_dict["opt_kwargs"]["options"]["ph_xhat_options"]["rho_multiplier"] = cfg.ph_xhat_rho_multiplier
    ...
    if _hasit(cfg, "ph_xhat_restart_iters"):
        ph_xhat_dict["opt_kwargs"]["options"]["ph_xhat_options"]["restart_iters"] = cfg.ph_xhat_restart_iters
    if _hasit(cfg, "ph_xhat_verbose"):
        ph_xhat_dict["opt_kwargs"]["options"]["ph_xhat_options"]["verbose"] = cfg.ph_xhat_verbose
    return ph_xhat_dict
